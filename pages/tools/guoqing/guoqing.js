// pages/tools/guoqing/guoqing.js
...
Page({
    ...
    initCanvas(index){
      ...
      ctx.drawImage(`../../../static/images/guoqing/hat${index}.png`, 0, 0, num, num)
      ctx.stroke()
      ctx.draw(false, () => {
    ...
    drawImg(avatarUrl){
      ...
      // ../../../static/images/guoqing/head${index}.png
      // hat0.png  avg.jpg
      let promise2 = new Promise(function(resolve, reject) {
        wx.getImageInfo({
          src: `../../../static/images/guoqing/hat${index}.png`,
          success: function(res) {
            console.log(res)
            resolve(res);
          }
